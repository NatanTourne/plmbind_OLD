...
used_model = "facebook/esm2_t30_150M_UR50D" #"facebook/esm2_t6_8M_UR50D"
...
embeddings_name = "t30_640_pad_trun" # "t12_480_pad_trun" # "t6_320_pad_trun"
...
for TF in tqdm(TF_names, desc="Fetching TF embeddings"):
    ...
    inputs = tokenizer(protein_seq, return_tensors="pt", padding = 'max_length', truncation = True, max_length=1024)
