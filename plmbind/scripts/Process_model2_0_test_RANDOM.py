...
from plmbind.models import PlmbindFullModel_RANDOM
...
parser.add_argument("--emb", help="Protein embeddings to use", default = "t6_320_RANDOM")
...
##### val_TF_loss_model ####
Full_model = PlmbindFullModel_RANDOM.load_from_checkpoint(val_TF_loss_model_loc)
...
Full_model = PlmbindFullModel_RANDOM.load_from_checkpoint(train_TF_loss_model_loc)
