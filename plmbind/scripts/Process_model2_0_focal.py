...
from plmbind.models import PlmbindFullModel_focal
...
##### val_TF_loss_model ####
Full_model = PlmbindFullModel_focal.load_from_checkpoint(val_TF_loss_model_loc)
...
Full_model = PlmbindFullModel_focal.load_from_checkpoint(train_TF_loss_model_loc)
