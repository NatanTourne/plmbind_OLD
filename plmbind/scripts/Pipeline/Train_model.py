...
from plmbind.models import FullTFModel, FullTFModel_small, PlmbindFullModel
...
parser.add_argument("--res", help="Resolution", type=int, default=128)
...
parser.add_argument("--train_loc", help="Location of training data",default ="/home/natant/Thesis-plmbind/Data/Not_used/ReMap_testing_2/train_no_alts.h5t")
parser.add_argument("--val_loc", help="Location of validation data", default ="/home/natant/Thesis-plmbind/Data/Not_used/ReMap_testing_2/val_no_alts.h5t")
parser.add_argument("--test_loc", help="Location of test data", default ="/home/natant/Thesis-plmbind/Data/Not_used/ReMap_testing_2/test_no_alts.h5t")
...
wandb_logger.experiment.config["Resolution"] = args.res
