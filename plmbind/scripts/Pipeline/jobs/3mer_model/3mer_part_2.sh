...
python "${pipeline_dir}/Process_kmer_model2_0.py" --out_dir "${current_dir}/${name}" --emb 3mer_pad_trun --num_DNA_filters 60
...
python "${pipeline_dir}/Process_kmer_model2_0.py" --out_dir "${current_dir}/${name}" --emb 3mer_pad_trun --num_DNA_filters 90
python "${pipeline_dir}/Process_predicts.py" --out_dir "${current_dir}/${name}"
