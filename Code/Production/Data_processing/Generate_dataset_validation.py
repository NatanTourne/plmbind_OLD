...
data = pd.read_csv("/home/natant/Thesis/Data/ReMap/remap2022_nr_macs2_hg38_v1_0.bed", sep = "\t", header = None)
data.head()

import py2bit
tb = py2bit.open("/home/natant/Thesis/Data/Genomes/hg38.2bit")
...
for chrom_name in chrom_order[4:8]: # FOR FULL DATA :[4:8]
...
f = h5torch.File("/home/natant/Thesis/Data/ReMap_TRAIN_TEST_SPLIT/remap_val.h5t", "w")
